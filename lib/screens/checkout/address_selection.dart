...
class _AddressSelectionSheetState extends State<AddressSelectionSheet> {
  ...
  final String googleApiKey =
      "AIzaSyBYJbjMnqYFSQ1lssqHH4A52HWD1H13FtI"; // Replace with dotenv.env['GOOGLE_MAPS_API_KEY']!
  ...
  void _confirmAddress() {
    if (_selectedAddress != null && _selectedAddress!.isNotEmpty && _selectedLocation != null) {
      widget.onSelectAddress(_selectedAddress!, _selectedLocation!.latitude, _selectedLocation!.longitude);
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Text("Selected Address:", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
