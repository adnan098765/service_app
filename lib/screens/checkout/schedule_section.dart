...
class _ScheduleSectionState extends State<ScheduleSection> {
  ...
  static List<String> _generateTimeSlots() {
    ...
    for (int hour = 9; hour <= 22; hour++) {
      slots.add('${hour > 12 ? hour - 12 : hour}:00 ${hour >= 12 ? 'PM' : 'AM'}');
      if (hour < 22) {
        slots.add('${hour > 12 ? hour - 12 : hour}:30 ${hour >= 12 ? 'PM' : 'AM'}');
      }
    }
    return slots;
  }
        ...
        Row(
          children: [
            ...
            widget.selectedDate != null && widget.selectedTime != null
                ...
                : Text("No date/time selected", style: TextStyle(color: Colors.grey)),
          ],
        ),
        SizedBox(height: 16),
        Container(
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(
                      color: _selectedIndex == index ? AppColors.appColor : Colors.transparent,
                      width: 2,
                    ),
