                ...
                Row(
                  children: [
                    ...
                    Material(
                      ...
                      color: Colors.grey,
                      child: Padding(padding: const EdgeInsets.all(4.0), child: Text("Primary")),
                    ),
                    Checkbox(
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)),
                      activeColor: AppColors.darkBlueShade,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      CustomText(text: "Payment Method", fontSize: 14, fontWeight: FontWeight.bold),
                    ],
                  ),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: width * 0.020),
                      CustomText(text: "Use wallet", fontSize: 12, fontWeight: FontWeight.bold),
                    ],
                  ),
                  Transform.scale(
                    scale: 0.6,
