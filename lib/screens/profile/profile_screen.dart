...
import 'package:untitled2/web_pages/about_us.dart';
import 'package:untitled2/web_pages/privacy_policy.dart';
import 'package:untitled2/web_pages/terms_and_conditions.dart';
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => AuthenticationScreen(customerId: 1)),
                ); // Close the dialog
              },
            ...
            children: [
                        ...
                        child: Stack(
                          children: [
                            ...
                            Positioned(
                              ...
                              right: 0,
                              child: Container(
                                decoration: const BoxDecoration(color: AppColors.whiteTheme, shape: BoxShape.circle),
                                child: const Padding(
              ...
              Column(
                children: [
                  ...
                  InkWell(onTap: _logOu, child: MenuTile(icon: Icons.logout, title: "Log Out")),
                ],
              ),
            ],
          ),
