...
class BottomNavScreen extends StatefulWidget {
  ...
  const BottomNavScreen({super.key, this.latitude, this.longitude, this.address, this.city, this.isManualLocation});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: _onItemTapped,
        items: [
          BottomNavigationBarItem(icon: Icon(Icons.home, size: Adaptive.w(7)), label: ''),
          BottomNavigationBarItem(icon: Icon(Icons.list, size: Adaptive.w(7)), label: ''),
          BottomNavigationBarItem(icon: Icon(Icons.person, size: Adaptive.w(7)), label: ''),
        ],
      ),
    );
  }
