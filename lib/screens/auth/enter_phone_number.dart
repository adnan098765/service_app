            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomText(text: "Welcome to our company", fontSize: 22.sp, fontWeight: FontWeight.bold),
                  CustomText(text: "Please enter your phone number to continue", fontSize: 16.sp),
                  SizedBox(height: Adaptive.h(4)),
                  Container(
                  ...
                  Obx(
                    () => GestureDetector(
                      onTap: controller.isPhoneValid.value ? () => controller.verifyPhoneNumber(context) : null,
                      child:
                          controller.isLoading.value
                              ...
                              : Container(
                                ...
                                width: width,
                                decoration: BoxDecoration(
                                  color: controller.isPhoneValid.value ? AppColors.buttonColor : Colors.grey,
