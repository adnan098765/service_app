...
class OtpScreen extends StatelessWidget {
  ...
  const OtpScreen({super.key, required this.phoneNumber, required this.customerId, this.token, this.actualOtp});
  ...
  Widget build(BuildContext context) {
    debugPrint(
      'OtpScreen initialized with phoneNumber: $phoneNumber, customerId: $customerId, token: $token, actualOtp: $actualOtp',
    );
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const CustomText(text: "We've sent a 4-digit verification code to", fontSize: 16, color: Colors.grey),
              ...
              Center(
                child: Pinput(
                  ...
                  focusedPinTheme: defaultPinTheme.copyWith(
                    decoration: defaultPinTheme.decoration!.copyWith(border: Border.all(color: AppColors.appColor)),
                  ),
                  showCursor: true,
                  onCompleted: (pin) {
              ...
              Container(
                ...
                child: const Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('SMS Troubleshooting:', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                    SizedBox(height: 4),
                    Text(
                ...
                child: Obx(
                  () => TextButton(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        color: controller.isResendEnabled.value ? AppColors.appColor : Colors.grey,
                        fontWeight: FontWeight.bold,
                      ),
                    ),
                  ),
