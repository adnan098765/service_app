      ...
      floatingActionButton: isVisible
        ...
        onPressed: () {
          final selectedServiceDetails = widget.services
              ...
              .map(
                (service) => {'service': service, 'quantity': selectedServices[service.serviceName] ?? 0},
          )
              .toList();
          debugPrint(
            'CategoryDetailsScreen: Navigating to CheckoutScreen with selectedServices=$selectedServices',
          );
          Navigator.push(
            context,
            MaterialPageRoute(
        ...
        label: Row(
          children: [
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(color: AppColors.whiteTheme, fontSize: 14),
              ),
            ),
            SizedBox(width: width * 0.015),
            Text("Continue", style: TextStyle(color: AppColors.whiteTheme, fontSize: 16)),
            SizedBox(width: width * 0.015),
          ...
          : null,
      appBar: AppBar(
        title: Text(widget.category.categoryName ?? 'Unknown Category'),
        backgroundColor: AppColors.whiteTheme,
              ...
              child: widget.services.isEmpty
                ...
                itemBuilder: (context, index) {
                  ...
                  return ServiceCardWidget(
                    ...
                    oldPrice: service.regularPrice ?? '0',
                    newPrice: service.salePrice?.isNotEmpty ?? false ? service.salePrice! : service.regularPrice ?? '0',
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      if (widget.oldPrice.isNotEmpty && widget.oldPrice != widget.newPrice)
                        Text(
                          'Rs. ${widget.oldPrice}',
