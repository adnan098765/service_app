...
//     return Scaffold(
//       appBar: AppBar(
//         title: CustomText(text: 'Add New Address', fontSize: 18.sp, fontWeight: FontWeight.bold, color: Colors.white),
...
//               child: GoogleMap(
//                 initialCameraPosition: CameraPosition(target: LatLng(latitude.value, longitude.value), zoom: 14),
...
//                 children: [
//                   CustomText(text: 'Enter Address Details', fontSize: 16.sp, fontWeight: FontWeight.w600),
...
//                   CustomText(text: 'Saved Addresses', fontSize: 16.sp, fontWeight: FontWeight.w600),
//                   SizedBox(height: Adaptive.h(1)),
//                   Obx(
//                     () =>
//                         controller.savedAddresses.isEmpty
//                             ? CustomText(text: 'No saved addresses', fontSize: 14.sp, color: Colors.grey)
//                             : ListView.builder(
//                               shrinkWrap: true,
...
//                                   child: ListTile(
//                                     title: CustomText(text: address.address ?? 'No Address', fontSize: 14.sp),
//                                     subtitle: CustomText(text: address.addressType ?? 'home', fontSize: 12.sp),
//                                     trailing: address.isDefault == true ? Icon(Icons.check, color: Colors.green) : null,
//                                     onTap: () {
