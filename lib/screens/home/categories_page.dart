...
import 'package:untitled2/screens/Controlller/all_category_services.dart';
import 'package:untitled2/screens/Controlller/home_controller.dart';
import 'package:untitled2/screens/home/view_all_services/category_details_screen/category_detail_screen.dart';
      ...
      MaterialPageRoute(
        builder:
            (context) => CategoryDetailsScreen(
              category: Category(id: category.id, categoryName: category.categoryName, image: category.image),
              services: servicesController.services.where((s) => s.category?.id == category.id).toList(),
            ),
      ),
    );
  }
